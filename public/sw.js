/* офлайн-кэш оболочки */
const C = 'tesa-v6';
const SHELL = ['./', 'index.html', 'styles.css', 'app.js', 'model.js', 'hours.js', 'manifest.webmanifest', 'icon.svg', 'icon-192.png', 'icon-512.png', 'logos/bti.png', 'logos/upm.png', 'logos/valmet.png'];
